...
// Views routes
Route::middleware(['auth:sanctum', 'verified', 'complete.kyc', 'active.account'])->get('/dashboard', [ViewsController::class, 'dashboard'])->name('dashboard');

Route::middleware(['auth:sanctum', 'verified', 'active.account'])->prefix('dashboard')->group(function () {
	...
	Route::middleware('complete.kyc')->group(function () {
		...
		// Card delivery routes
		Route::post('/cards/delivery/request', [CardController::class, 'requestDelivery'])->name('cards.delivery.request');
		Route::get('/cards/delivery/status', [CardController::class, 'deliveryStatus'])->name('cards.delivery.status');

		// Card delivery routes
		Route::post('/cards/{card}/request-delivery', [CardController::class, 'requestDelivery'])->name('cards.request-delivery');
		Route::get('/cards/{card}/delivery-history', [CardController::class, 'deliveryHistory'])->name('cards.delivery-history');
