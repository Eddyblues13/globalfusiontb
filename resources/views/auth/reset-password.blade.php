...
<div class="flex flex-col lg:flex-row min-h-screen">
    ...
    <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-600 to-primary-800 relative overflow-hidden">
        ...
        <div class="relative flex flex-col justify-center items-center w-full h-full text-white p-12 z-10">
            <!-- Logo -->
            <a href="/" class="mb-6">
                <img src="{{ asset('storage/' . $settings->logo) }}" alt="Logo" class="h-16 filter brightness-0 invert">
            </a>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                ...
                <div class="px-8 pt-8 pb-6">
                    ...
                    <p class="mt-2 text-sm text-gray-600">Enter your email and set a new password for your {{
                        $settings->site_name }} account.</p>
                </div>
                            ...
                            <div class="input-wrapper">
                                <div class="relative">
                                    ...
                                    <button type="button"
                                        ...
                                        <i data-lucide="eye-off" id="hide-password"
                                            class="h-5 w-5 text-gray-400 hidden"></i>
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="input-wrapper">
                                <div class="relative">
                                    ...
                                    <button type="button"
                                        ...
                                        class="absolute inset-y-0 right-0 flex items-center pr-3 input-toggle">
                                        <i data-lucide="eye" id="show-password-confirm"
                                            class="h-5 w-5 text-gray-400"></i>
                                        <i data-lucide="eye-off" id="hide-password-confirm"
                                            class="h-5 w-5 text-gray-400 hidden"></i>
                                    </button>
                                </div>
                            </div>
