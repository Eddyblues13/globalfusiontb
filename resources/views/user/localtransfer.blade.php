...
<div x-data="{ 
        ...
        <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
            ...
            <div class="p-6 md:p-8">
                <form @submit.prevent="showPreview = true" id="transferForm">
                    ...
                    <div
                        class="bg-gradient-to-br from-blue-50 to-white p-4 rounded-xl border border-blue-100 mb-6 shadow-sm">
                            ...
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-xl font-bold text-gray-900">{{
                                        ...
                                        number_format(Auth::user()->account_bal, 2, '.', ',') }}</p>
                                </div>
                            </div>
                    ...
                    <div
                        class="mb-6 bg-gradient-to-br from-gray-50 to-white p-5 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div class="mt-4 flex flex-wrap gap-2">
                            ...
                            <button type="button" @click="amount = Math.floor({{ Auth::user()->account_bal }})"
                                class="px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-md text-sm font-medium text-gray-700 transition-colors">All</button>
                        </div>
                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mt-5">
                                ...
                                <div>
                                    <label for="Accounttype"
                                        class="block text-sm font-medium text-gray-700 mb-1">Transfer Type</label>
                                    <div class="relative">
                                        <div
                                            class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div class="bg-white rounded-xl border border-gray-200 p-5">
                            ...
                            <div class="mb-5">
                                <label for="Description"
                                    class="block text-sm font-medium text-gray-700 mb-1">Description/Memo</label>
                                <div class="relative">
                            ...
                            <!-- Transaction PIN -->
                            <div>
                                <label for="pin" class="block text-sm font-medium text-gray-700 mb-1">Transaction
                                    PIN</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                        <i data-lucide="lock" class="h-5 w-5 text-gray-400"></i>
                                    </div>
                                    <input type="password" name="pin" id="pin" x-model="pin"
                                    ...
                                    <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                        <button type="button"
                                            ...
                                            <i data-lucide="eye" class="h-5 w-5"
                                                x-show="document.getElementById('pin').type === 'password'"></i>
                                            <i data-lucide="eye-off" class="h-5 w-5"
                                                x-show="document.getElementById('pin').type === 'text'"
                                                style="display: none;"></i>
                                        </button>
                                    </div>
                                </div>
                                <p class="mt-1 text-xs text-gray-500">This is your transaction PIN, not your login
                                    password</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Transfer Summary -->
                    <div x-show="amount > 0"
                        class="mb-6 bg-gradient-to-br from-primary-50 to-white p-5 rounded-xl border border-primary-100 shadow-sm">
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-medium text-gray-700">{{ config('currencies.'.Auth::user()->currency,
                                    '$') }}<span x-text="parseFloat(amount || 0).toFixed(2)"></span></span>
                            </div>
                            ...
                            <div class="border-t border-gray-200 pt-2 mt-2">
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="font-bold text-xl text-gray-900">{{
                                        config('currencies.'.Auth::user()->currency, '$') }}<span
                                            x-text="parseFloat(amount || 0).toFixed(2)"></span></span>
                                </div>
                                ...
                                <div class="flex justify-between items-center mt-1">
                                    ...
                                    <span class="font-medium text-gray-700">{{
                                        config('currencies.'.Auth::user()->currency, '$') }}<span
                                            x-text="({{ Auth::user()->account_bal }} - parseFloat(amount || 0)).toFixed(2)"></span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:space-x-4">
                        <button type="submit"
                            ...
                            <span
                                ...
                                :class="{ 'translate-x-full': !amount || !accountname || !accountnumber || !bankname || !pin }"></span>
                        </button>
        ...
        <div class="mt-6 mb-6 p-5 border border-gray-200 rounded-lg bg-white shadow-sm">
            <div class="flex items-start">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-xs text-gray-500 mt-1">All transfers are encrypted and processed securely. Your
                        financial information is never stored on our servers.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Preview Modal -->
    <div x-show="showPreview" x-cloak class="fixed inset-0 z-50 overflow-y-auto"
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-100">
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                <span class="text-gray-500">Amount</span>
                                <span class="font-medium text-gray-900">{{ config('currencies.'.Auth::user()->currency,
                                    '$') }}<span x-text="parseFloat(amount).toFixed(2)"></span></span>
                            </div>
                            ...
                            <div class="border-t border-gray-200 pt-2 mt-2">
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold text-gray-900">{{
                                        config('currencies.'.Auth::user()->currency, '$') }}<span
                                            x-text="parseFloat(amount).toFixed(2)"></span></span>
                                </div>
                                ...
                                <div class="flex justify-between mt-1">
                                    ...
                                    <span class="font-medium text-gray-900">{{
                                        config('currencies.'.Auth::user()->currency, '$') }}<span
                                            x-text="({{ Auth::user()->account_bal }} - parseFloat(amount)).toFixed(2)"></span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start text-sm mb-2 p-3 bg-amber-50 border-l-4 border-amber-400 rounded-r-md">
                        ...
                        <p class="text-amber-800">
                            Please verify the transfer details carefully before proceeding. Once confirmed, transfers
                            cannot be reversed.
                        </p>
                    </div>
