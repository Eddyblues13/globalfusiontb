        ...
        <div class="p-5">
            <div class="flex items-center">
                ...
                <div class="ml-5">
                    ...
                    <h3 class="text-lg font-semibold text-gray-900">{{ config('currencies.'.Auth::user()->currency, '$')
                        }} {{ number_format($totalBalance, 2) }}</h3>
                </div>
            </div>
        </div>
    </div>
...
<div class="bg-primary-700 rounded-xl overflow-hidden shadow-md mb-6">
    <div class="md:flex">
        <div class="p-6 md:flex-1">
            ...
            <p class="text-gray-100 mb-4">Create virtual cards for secure online payments, subscription management, and
                more. Our virtual cards offer enhanced security and control over your spending.</p>
            ...
            <div class="mt-6">
                <a href="{{ route('cards.apply') }}"
                    class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-primary-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white focus:ring-offset-primary-600">
                    Apply Now
                </a>
            </div>
        </div>
        <div class="hidden md:flex md:items-center md:justify-center md:w-1/3 bg-primary-700 bg-opacity-50 p-6">
            <div class="relative w-48 h-32">
                <div
                    class="absolute w-full h-full transform rotate-6 rounded-xl bg-gradient-to-br from-gray-900 to-gray-800 shadow-lg">
                </div>
                <div
                    class="absolute w-full h-full rounded-xl bg-gradient-to-r from-primary-800 to-primary-600 shadow-lg">
...
<div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
        ...
        <div
            class="bg-white rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300 group overflow-hidden">
            ...
            <div class="px-4 py-3">
                <div class="w-full h-44 backface-hidden relative overflow-hidden">
                    ...
                    <div class="absolute inset-0 rounded-xl bg-gradient-to-br from-blue-800 via-blue-600 to-blue-500">
                    </div>
                    @elseif($card->card_type == 'mastercard')
                    <div
                        class="absolute inset-0 rounded-xl bg-gradient-to-br from-red-700 via-orange-600 to-orange-500">
                    </div>
                    @elseif($card->card_type == 'american_express')
                    <div class="absolute inset-0 rounded-xl bg-gradient-to-br from-gray-800 via-gray-700 to-gray-600">
                    </div>
                    @else
                    <div class="absolute inset-0 rounded-xl bg-gradient-to-br from-gray-800 via-gray-700 to-gray-600">
                    </div>
                    ...
                    <div class="absolute inset-0 p-4 flex flex-col justify-between">
                        ...
                        <div class="flex justify-between items-start">
                            <div>
                                <div class="text-white font-semibold text-sm sm:text-base tracking-wider">{{
                            ...
                            <div>
                                @if($card->card_type == 'visa')
                                <svg class="h-6 w-12 text-white" viewBox="0 0 1000 324" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path d="M433.334 318.516H348.568L403.315 5.01855H488.081L433.334 318.516Z"
                                        fill="white" />
                                    <path
                                        d="M727.98 15.9043C712.039 9.56622 686.227 2.51855 653.355 2.51855C574.054 2.51855 519.055 45.5277 518.802 106.826C518.306 152.343 558.126 177.912 587.98 193.316C618.34 209.233 629.315 219.335 629.315 233.014C629.061 254.008 603.493 263.591 579.702 263.591C547.839 263.591 530.7 258.287 505.123 245.892L493.902 240.335L482.166 313.221C501.069 323.07 536.096 331.667 572.643 332.163C657.140 332.163 711.128 289.897 711.895 224.144C712.394 188.508 689.871 160.445 643.015 136.910C615.200 121.744 598.306 111.638 598.554 97.2356C598.554 84.5987 613.224 70.9167 648.747 70.9167C677.823 70.4206 699.053 77.7188 715.707 85.5144L726.681 90.8186L738.417 19.9214L727.98 15.9043Z"
                                        fill="white" />
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        d="M841.897 5.01855H773.691C755.782 5.01855 742.397 10.0624 734.862 30.0238L630.236 318.516H715.464C715.464 318.516 729.143 280.806 732.429 272.002C742.901 272.002 822.706 272.002 835.844 272.002C838.373 283.215 845.930 318.516 845.930 318.516H922.667L841.897 5.01855ZM762.220 208.490C769.018 189.752 796.850 116.686 796.850 116.686C796.602 117.174 803.160 99.1900 806.699 88.0899L812.020 114.188C812.020 114.188 829.775 192.026 833.061 208.490H762.220Z"
                                        fill="white" />
                                    <path
                                        d="M251.994 5.01855L171.471 219.335L162.137 174.313C146.216 129.054 102.175 80.0894 52.8662 56.8035L126.462 318.020H212.215L336.832 5.01855H251.994Z"
                                        fill="white" />
                                    <path
                                        d="M127.963 5.01855H0.662110L0.167969 10.3101C98.1497 31.7971 163.301 76.5646 190.132 129.298L162.633 13.5747C157.329 -0.60098 144.316 5.51465 127.963 5.01855Z"
                                        fill="white" />
                                </svg>
                                @elseif($card->card_type == 'mastercard')
                                <svg class="h-8 w-12" viewBox="0 0 131.39 86.90" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity=".9">
                                        ...
                                        <path
                                            ...
                                            fill="#fff" />
                                        <path d="M123.94 43.45a36 36 0 01-58 28.3 36 36 0 000-56.61 36 36 0 0158 28.3z"
                                            fill="#fff" />
                                    </g>
                                </svg>
                                @elseif($card->card_type == 'american_express')
            ...
            <div class="px-4 py-3 border-t border-gray-100">
                <div class="flex justify-between items-center mb-2">
                    ...
                    @if($card->status == 'active')
                    <div class="text-sm font-semibold text-gray-900">{{ $card->currency }} {{
                ...
                <div class="grid grid-cols-2 gap-2 mt-2">
                    <a href="{{ route('cards.view', $card) }}"
                        class="text-center px-3 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200">
                        View Details
                    </a>
                    ...
                    <button type="button" disabled
                        class="px-3 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-gray-400 cursor-not-allowed transition-colors duration-200">
                        Request Delivery
                    </button>
                    @endif
                </div>
...
<div id="deliveryModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden z-50">
    <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <form id="deliveryForm" method="POST" action="{{ route('cards.delivery.request') }}" class="mt-4 space-y-4">
                @csrf
                ...
                <div>
                    <label for="nearest_airport" class="block text-sm font-medium text-gray-700">Nearest Airport
                        (Optional)</label>
...
<div class="mb-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <p class="text-gray-600">Complete the application form for your virtual card. Select your preferred card
                type and set your spending limits.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <p class="text-gray-600">Once approved, your virtual card will be ready to use. View the card details and
        ...
        <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
            ...
            <p class="text-gray-600">Use your virtual card for online transactions anywhere major credit cards are
                accepted. Monitor transactions in real-time.</p>
        </div>
    </div>
</div>
    ...
    <div class="p-6">
        <dl class="space-y-6">
            <div>
                ...
                <dd class="mt-2 text-sm text-gray-600">A virtual card is a digital payment card that can be used for
                    online transactions. It works just like a physical card but exists only in digital form, providing
                    enhanced security for online purchases.</dd>
            </div>

            <div>
                <dt class="text-base font-medium text-gray-900">How secure are virtual cards?</dt>
                <dd class="mt-2 text-sm text-gray-600">Virtual cards offer additional security as they're separate from
                    your primary account. You can create cards with specific spending limits and even create single-use
                    cards for enhanced protection against fraud.</dd>
            </div>

            <div>
                <dt class="text-base font-medium text-gray-900">Can I have multiple virtual cards?</dt>
                <dd class="mt-2 text-sm text-gray-600">Yes, you can apply for multiple virtual cards for different
                    purposes - such as one for subscriptions, another for shopping, etc. Each card can have its own
                    limits and settings.</dd>
            </div>

            <div>
                <dt class="text-base font-medium text-gray-900">How long does it take to get a virtual card?</dt>
                <dd class="mt-2 text-sm text-gray-600">Virtual cards are typically issued within minutes after approval.
                    Once approved, you can immediately view and use the card details for online transactions.</dd>
            </div>
        </dl>
    </div>
</div>
