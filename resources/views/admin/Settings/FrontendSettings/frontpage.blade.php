                ...
                <div class="col-12">
                    <nav>
                        <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            ...
                            <a class="mb-2 nav-item nav-link" id="nav-about-tab" data-toggle="tab" href="#4" role="tab"
                                aria-controls="nav-about" aria-selected="false">IMAGES</a>
                        </div>
                    </nav>
                    ...
                    <div class="px-3 py-3 tab-content px-sm-0" id="nav-tabContent">
                                    ...
                                    <div class="p-1 col-md-4">
                                        <div class="card border p-1 ">
                                            <div class="card-body">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#editfaq{{ $faq->id }}"
                                                    ...
                                                    <form action="{{ route('updatefaq') }}" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="answer"
                                                                placeholder="Enter the Answer to the question above"
                        ...
                        <div class="tab-pane fade p-3" id="2" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <div class="boxes">
                                <div class="row">
                                        ...
                                        <div class="card border p-1 ">
                                            ...
                                            <div class="card-body">
                                                <a href="{{ url('admin/dashboard/deltestimony') }}/{{ $faq->id }}"
                                                    ...
                                                    class="btn btn-sm btn-danger" data-original-title="Remove"><i
                                                        class="fa fa-times"></i></a> &nbsp; &nbsp;
                                                <a href="#" data-toggle="modal" data-target="#edittes{{ $faq->id }}"
                                                    class="btn btn-primary btn-sm">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="{{ route('updatetestimony') }}" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="testifier" placeholder="Full name"
                                                                value="{{ $faq->name }}" class="form-control  ">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="said" class="form-control  "
                                                                rows="4">{{ $faq->what_is_said }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <h5 class=" ">Picture</h5>
                        ...
                        <div class="tab-pane fade p-3" id="3" role="tabpanel" aria-labelledby="nav-contact-tab">
                            <div class="boxes">
                                <div class="row">
                                    ...
                                    <div class="p-1 col-md-3">
                                        <div class="card border p-1 ">
                                            <div class="card-body">
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#editcont{{ $faq->id }}"
                                                    class="btn btn-primary btn-sm">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="{{ route('updatecontents') }}" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="title"
                                                                placeholder="Name of Content" value="{{ $faq->title }} "
                                                                class="form-control  " required>
                                                        </div>
                                                        <div class="form-group">
                        ...
                        <div class="tab-pane fade p-3" id="4" role="tabpanel" aria-labelledby="nav-about-tab">
                            <div class="boxes">
                                <div class="row">
                                    ...
                                    <div class="p-1 col-md-4">
                                        <div class="card border p-1 ">
                                            ...
                                            <div class="card-body">
                                                <a href="#" data-toggle="modal" data-target="#editimg{{ $faq->id }}"
                                                    class="btn btn-primary btn-sm">Edit</a>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <form action="{{ route('updateimg') }}" method="post"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" name="img_title"
                                                                value="{{ $faq->title }}" placeholder="Name of Image"
                                                                class="form-control  ">
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <textarea name="img_desc" placeholder="Describe the image"
                                                                class="form-control  "
                                                                rows="2">{{ $faq->description }}</textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <h5 class="">Image</h5>
