                            ...
                            <form action="{{ route('processkyc') }}" method="post">
                                ...
                                <div class="form-group">
                                    <textarea name="message" placeholder="Enter Message "
                                        ...
                                        required>This is to inform you that following the documents you submited, your account have been verified. You can now enjoy all our services without restrictions. Cheers!!</textarea>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->user->name}}</h2>
                                    <small class="text-muted">First name</small>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->user->middlename }}</h2>
                                    <small class="text-muted">Last name</small>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->user->lastname }}</h2>
                                    <small class="text-muted">Last name</small>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->user->email }}</h2>
                                    <small class="text-muted">Email</small>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->user->phone }}</h2>
                                    <small class="text-muted">Phone Number</small>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->user->dob }}</h2>
                                    <small class="text-muted">Date of Birth</small>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->statenumber }}</h2>
                                    <small class="text-muted">SSN</small>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->accounttype }}</h2>
                                    <small class="text-muted">Account Type</small>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->income }}</h2>
                                    <small class="text-muted">Income Range</small>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <h2 class="text-{{ $text }}">{{ $kyc->employer }}</h2>
