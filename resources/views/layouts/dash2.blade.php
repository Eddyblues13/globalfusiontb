            ...
            <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto">
                ...
                <nav class="flex-1 px-4 space-y-1">
                    ...
                    <a href="{{ route('cheque.deposit') }}"
                        class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('cheque.deposit') ? 'bg-primary-50 text-black border-l-4 border-primary-500 pl-2' : 'text-gray-700 hover:bg-gray-50' }}">
                        <i data-lucide="file-text"
                            class="mr-3 h-5 w-5 {{ request()->routeIs('cheque.deposit') ? 'text-black' : 'text-gray-500' }}"></i>
                        Cheque Deposit
                    </a>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="hidden md:flex items-center px-3 py-1.5 bg-primary-50 rounded-full">
                            ...
                            <span class="text-sm font-medium text-gray-900">
                                ...
                                number_format(Auth::user()->account_bal,0, '.', ',') }}
                            </span>
                        </div>
