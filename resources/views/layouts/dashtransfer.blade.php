...
<head>
    ...
    <link href="{{ asset('dash2/konanauth/public/asset/fonts/fontawesome/css/all.css') }}" rel="stylesheet"
        type="text/css">
    <link href="{{ asset('dash2/public/dashboard/plugins/custom/leaflet/leaflet.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('dash2/konanauth/public/dashboard/plugins/global/plugins.bundle.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('dash2/konanauth/public/dashboard/css/style.bundle.css') }}" rel="stylesheet"
        type="text/css" />
...
<script src="{{ asset('dash2/konanauth/public/asset/fonts/fontawesome/js/all.js') }}"></script>
<script src="{{ asset('dash2/konanauth/public/vendor/livewire/livewire.js?id=90730a3b0e7144480175') }}"
    data-turbo-eval="false" data-turbolinks-eval="false">
</script>
